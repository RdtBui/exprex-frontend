        ...
        <div class="col no-gutters position-relative" style={{ padding: '0' }}>
            ...
            <div class="flex-row no-gutters">
                <div class="section3 d-flex justify-content-center align-items-center px-5">
                    <div class="row p-5">
                        <div class="col-sm-3">
                            <div class="card text-center m-1 py-5 bounce-in-top" style={{ backgroundColor: "rgb(156, 194, 154)", borderRadius: "20px", border: "none" }}>
                                <div class="card-body">
                                    <h5 class="card-title">
                        ...
                        <div class="col-sm-3">
                            <div class="card text-center m-1 py-5 bounce-in-top" style={{ backgroundColor: "rgb(91, 110, 198)", borderRadius: "20px", border: "none" }}>
                                <div class="card-body">
                                    <h5 class="card-title">
                        ...
                        <div class="col-sm-3">
                            <div class="card text-center m-1 py-5 bounce-in-top" style={{ backgroundColor: "rgb(210, 157, 147)", borderRadius: "20px", border: "none" }}>
                                <div class="card-body">
                                    <h5 class="card-title">
                        ...
                        <div class="col-sm-3">
                            <div class="card text-center m-1 py-5 bounce-in-top" style={{ backgroundColor: "rgb(159, 205, 251)", borderRadius: "20px", border: "none" }}>
                                <div class="card-body">
                                    <h5 class="card-title">
